...
class CustomerTest {
    ...
    void customerAsKeyTest() {
        ...
        // then
        AssertionsForClassTypes.assertThat(factData).isEqualTo(expectedData);
        ...
        // then
        AssertionsForClassTypes.assertThat(factDataSecond).isEqualTo(expectedData);
    }
    ...
    void scoreSortingTest() {
        ...
        // then
        AssertionsForClassTypes.assertThat(notExists).isNull();
    }
